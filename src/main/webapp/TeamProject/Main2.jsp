		...
		<div id="nav_middle">
			<ul id="mainnav" class="clearfix">
				<li><a href="javascript:void(0)">매장관리메뉴</a>
					<ul class="subnav">
						<li><a href="/web/TeamProject/storeManagement.jsp">매장관리</a></li>
...
확인해보셨나요?</pre>
  	...
  	<div style="padding-top: 14%">
  	 <div class="section-grid">
         ...
         <div class="sec-lft">
            <div class="column column-notice" style="text-align: left">
               <!-- 공지사항 div -->
               <div>
                  <div class="stit">
                     <h3>공지사항</h3>
...
<br><br><br>
      ...
      <div class="sec-rgt">
         ...
         <ul class="login-link">
            <li><a href="#" style="text-decoration: none; color:black;">아이디</a>/<a
               href="#" style="text-decoration: none; color:black;">비밀번호 찾기</a></li>
            <li><a href="/web/TeamProject/register.jsp" style="color:black">회원가입</a></li>
         </ul>
      </div>
      </div>
</body>
